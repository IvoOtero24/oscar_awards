...
The only column with missing items is the 'film' column.
Let's explore the missing lines of this data to understand why,
and in which categories this is happening
